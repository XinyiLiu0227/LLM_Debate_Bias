...
if __name__ == "__main__":
    ...
    if os.path.exists(f'experiments/{file_prefix}_{model_name}_{args.seed}_{args.debate_num}_remove_forfeit_change_names_shuffledCP.json'):
        with open(f'experiments/{file_prefix}_{model_name}_{args.seed}_{args.debate_num}_remove_forfeit_change_names_shuffledCP.json', 'r') as f:
            for line in f:
    ...
    dir_name = f'{file_prefix}_{model_name}_remove_forfeit_change_names_shuffledCP_log'
    ...
    for debate_name in selected_debate_names:
        ...
        if prob > 0.5:
            ...
            #         you only need to give the character of either C, or P. C means user {masked_name[pro_index]} wins. P means user {masked_name[con_index]} wins. \
        ...
        with open(f'experiments/{file_prefix}_{model_name}_{args.seed}_{args.debate_num}_remove_forfeit_change_names_shuffledCP.json', 'a') as f:
