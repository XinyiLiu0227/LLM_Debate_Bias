...
if __name__ == "__main__":
    ...
    if os.path.exists(f'experiments/{file_prefix}_{model_name}_{args.seed}_{args.debate_num}_remove_forfeit_change_names_CP.json'):
        with open(f'experiments/{file_prefix}_{model_name}_{args.seed}_{args.debate_num}_remove_forfeit_change_names_CP.json', 'r') as f:
            for line in f:
    ...
    dir_name = f'{file_prefix}_{model_name}_remove_forfeit_change_names_CP_log'
    ...
    for debate_name in selected_debate_names:
        ...
        with open(f'experiments/{file_prefix}_{model_name}_{args.seed}_remove_forfeit_change_names_CP.json', 'a') as f:
